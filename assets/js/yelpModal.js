...
function yelpModal(x) {
    ...
    document.getElementById('yelpRating').textContent = x.rating;
    // document.getElementById('yelpRatingContainer').textContent = `<img src=${yelpImg}>`;
    // document.getElementById('yelpPic').src = yelpImg;
    document.getElementById('yelpPhone').textContent = x.display_phone;
